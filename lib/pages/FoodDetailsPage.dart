...
import 'package:flutter_food_delivery/pages/FoodOrderPage.dart';
import 'package:flutter_food_delivery/widgets/FoodDetailsSlider.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          systemOverlayStyle: SystemUiOverlayStyle.light, // Fixed brightness issue
          actions: <Widget>[
            IconButton(
              icon: const Icon(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FoodTitleWidget(
                productName: widget.productName,
                productPrice: widget.productPrice,
                productHost: widget.productHost,
              ),
              const SizedBox(
                height: 15,
              ),
              ...
              Navigator.push(
                ...
                ScaleRoute(
                  page: FoodOrderPage(
                    ...
                    productPrice: widget.productPrice,
                    productImage: 'ic_best_food_8',
                    productCartQuantity: _quantity.toString(),
                  ),
                ),
              );
            },
