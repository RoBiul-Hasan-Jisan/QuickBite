...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _signUp() {
    ...
    print('Signing up with: $firstName $lastName, phone: $phone, code: $invitationCode');
    
    // For demo purposes, navigate to home after sign up
            ...
            Flexible(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SignInButtonWidget(onPressed: _signUp),
                  const SizedBox(
                    height: 10,
                  ),
