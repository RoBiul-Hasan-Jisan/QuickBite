    ...
    return SafeArea(
      child: Container(
        ...
        child: TextFormField(
          ...
          onTap: () {
            debugPrint('Promo code field tapped');
          },
        ),
      ),
    );
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            debugPrint('Delete item: $productName');
                          },
                          child: Container(
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerRight,
                      child: AddToCartMenu(int.parse(productCartQuantity)),
                    )
                  ],
                ),
              )
...
class _AddToCartMenuState extends State<AddToCartMenu> {
  ...
  void initState() {
    super.initState();
    _quantity = widget.productCounter;
  }
    ...
    return Container(
      child: Row(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () => debugPrint('Add to cart: $_quantity'),
            child: Container(
              width: 100.0,
              height: 35.0,
              decoration: BoxDecoration(
